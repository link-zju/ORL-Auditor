...
if __name__ == "__main__":
    ...
    train_samples1 = original_probe_output[:5000]
    train_samples2 = original_probe_output[5000:10000]

    ndb = NDB(training_data=train_samples1, number_of_bins=k, whitening=True)
    ndb.evaluate(train_samples2, model_label='train')


    test_samples = suspected_model_output[:5000]
